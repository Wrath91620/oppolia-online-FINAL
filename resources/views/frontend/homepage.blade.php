    ...
    <div class="d-block d-md-none position-relative" dir="rtl">
        ...
        <div
            ...
            <h1 class="banner-text text-nowrap reveal-text reveal-line">
                أفكارك لبيت مثالي تنفيذها<br>
                صار أسهل مع <span class="highlight">اوبوليا اونلاين!</span>
            </h1>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center">
            <div class="col-12 col-md-12 d-flex align-items-center justify-content-center p-4">
                <h2 class="sub-title">عن اوبوليا</h2>
            </div>
...
<section class="steps-section">
    <div class="container">
        ...
        <div class="text-center mb-4">
            <h2 class="text-white sub-title">خطوات طلبك من عندنا</h2>
        </div>
        ...
        <div class="row g-3 justify-content-center text-white flex-column flex-lg-row align-items-center">
            ...
            <div class="col-12 col-sm-4 col-md-1 text-center">
                ...
                <p class="mt-2 text-nowrap" style="place-self: center;">احجز موعدك</p>
            </div>
            ...
            <div class="col-12 col-sm-4 col-md-1 text-center">
                ...
                <p class="mt-2 text-nowrap" style="place-self: center;">نجيلك البيت</p>
            </div>
            ...
            <div class="col-12 col-sm-4 col-md-1 text-center">
                ...
                <p class="mt-2 text-nowrap" style="place-self: center;">سجل القياسات والتفاصيل</p>
            </div>
            ...
            <div class="col-12 col-sm-4 col-md-1 text-center">
                ...
                <p class="mt-2 text-nowrap" style="place-self: center;">ابدأ من مخطط التصميم</p>
            </div>
            ...
            <div class="col-12 col-sm-4 col-md-1 text-center">
                ...
                <p class="mt-2 text-nowrap" style="place-self: center;">المتابعة معك</p>
            </div>
            ...
            <div class="col-12 col-sm-4 col-md-1 text-center">
                ...
                <p class="mt-2 text-nowrap" style="place-self: center;">الانتهاء وتركيب القطع</p>
            </div>
        </div>
    </div>
</section>
...
<section class="container p-5">
    <div class="row">
        <div class="col-12 text-end">
            <h3 class="section-title2 fw-bold mb-5 text-end">ايش رح تستفيد من خدمات اوبوليا اونلاين؟</h3>
            <div class="row text-end">
                <div class="col-12 col-md-4 mb-4">
                    <h5 class="text-title"><span class="badge bg-success number-span ms-2">1</span>سعره أنسب لك</h5>
                    <p class="text-content">راح تحصل على تصميم يساعدك في تخيل شكل مطبخك الجديد قبل ما تبدأ بالتنفيذ.</p>
                </div>
                <div class="col-12 col-md-4 mb-4">
                    <h5 class="text-title"><span class="badge bg-success number-span ms-2">2</span>أنت تختار على ذوقك</h5>
                    <p class="text-content">انت تختار التصميم اللي يعجبك وإحنا نسوي لك دراسة لتكلفته بناءً على ميزانيتك.</p>
                </div>
                <div class="col-12 col-md-4 mb-4">
                    <h5 class="text-title"><span class="badge bg-success number-span ms-2">3</span>مشاركتك في كل خطوة في رحلة التصميم</h5>
                    <p class="text-content">إحنا معاك في كل مرحلة من بداية الفكرة للتنفيذ، عشان نضمن لك كل شيء يناسب احتياجك.</p>
                </div>
                <div class="col-12 col-md-4 mb-4">
                    <h5 class="text-title"><span class="badge bg-success number-span ms-2">4</span>ذوقك يدخل في كل تفصيل</h5>
                    <p class="text-content">راح تقدر تختار المواد، الألوان، والخامات اللي تعجبك.</p>
                </div>
                <div class="col-12 col-md-4 mb-4">
                    <h5 class="text-title"><span class="badge bg-success number-span ms-2">5</span>يوصلك بدون عناء</h5>
                    <p class="text-content">يوصلك المطبخ كامل مع كل مكوناته لمكانك مباشرة.</p>
                </div>
                <div class="col-12 col-md-4 mb-4">
                    <h5 class="text-title"><span class="badge bg-success number-span ms-2">6</span>متابعة حتى بعد التركيب</h5>
...
<section class="py-5" style="background: rgba(80, 159, 150, 0.47);">
    <div class="container text-center" dir="rtl">
        <h2 class="fw-bold mb-5" style="color: rgba(10, 71, 64, 1);">ليش تختارنا؟</h2>
        <div class="row g-4 justify-content-center">
            ...
            text-center ">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <h5 class="why-us-icon">تصاميم مميزة</h5>
                        </div>
                        <div class="ms-3">
                            <p class="why-us-text">نقدم مجموعة واسعة من التصاميم الحديثة التي تناسب كل الأذواق، مع إمكانية التخصيص لتلبية احتياجاتك الخاصة.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            text-center">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <h5 class="why-us-icon">جودة عالية</h5>
                        </div>
                        <div class="ms-3">
                            <p class="why-us-text">نستخدم أفضل المواد والتقنيات في كل قطعة ننشأها، لضمان الاستخدام المريح.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            text-center">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <h5 class="why-us-icon">تجربة عملاء مميزة</h5>
                        </div>
                        <div class="ms-3">
                            <p class="why-us-text">نهتم برضا عملائنا ونسعى لتقديم خدمة عملاء استثنائية من البداية للنهاية.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            text-center">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <h5 class="why-us-icon">أسعار تنافسية</h5>
                        </div>
                        <div class="ms-3">
                            <p class="why-us-text">نقدم أسعار مناسبة تنافس السوق، بدون التنازل عن الجودة.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            text-center">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <h5 class="why-us-icon">سهولة التواصل</h5>
                        </div>
                        <div class="ms-3">
                            <p class="why-us-text">نكون معك في كل خطوة، من التصميم إلى التركيب، ونتابع معك حتى بعد التركيب.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            text-center">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <h5 class="why-us-icon">توصيل مريح</h5>
                        </div>
                        <div class="ms-3">
                            <p class="why-us-text">نضمن توصيل كل شيء لك بسهولة دون عناء.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            text-center">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <h5 class="why-us-icon">الالتزام بالمواعيد</h5>
                        </div>
                        <div class="ms-3">
                            <p class="why-us-text">نلتزم بمواعيد التسليم والتركيب، لضمان تجربة مريحة وسلسة.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            text-center">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <h5 class="why-us-icon">الضمان</h5>
                        </div>
                        <div class="ms-3">
                            <p class="why-us-text">نحن نقدم ضمانًا يمتد لمدة 15 سنة على منتجاتنا، مما يعكس ثقتنا بجودة تصاميمنا.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="container-fluid p-5">
    <div class="container text-center">
        <h2 class="fw-bold" style="color: rgba(10, 71, 64, 1) !important;">
            نضمن توصيل كل شيء بشكل آمن، دون عناء.
        </h2>
...
<section class="container p-5">
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-md-5 text-end">
            <h3 class="section-title">الجودة الألمانية</h3>
...
<section class="container text-center p-5">
    <h2 class="section-title">مصممو اوبوليا اونلاين!</h2>
