    ...
    <div class="col-12 mt-5 p-0">
        <div class="row d-flex align-items-center justify-content-center">
            ...
            <div class="col-lg-4 col-md-12 p-0">
                <img src="{{ asset('Frontend/assets/images/gallery/production.webp') }}" alt="Production Line"
                    class="img-fluid">
            </div>
        </div>
    </div>
                ...
                <div id="history" class="row m-4">
                            ...
                            <div class="row g-4 justify-content-center">
                                ...
                                <div class="col-md-3 col-sm-6 d-flex">
                                    <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100"
                                        ...
                                        <img src="{{ asset('Frontend/assets/images/icons/measurement.png') }}"
                                            class="card-icon mb-3" alt="تصاميم مميزة">
                                        <h5 class="fw-bold card-about">تصاميم مميزة</h5>
                                        <p>نقدم مجموعة واسعة من التصاميم العصرية، مع إمكانية التخصيص لتناسب احتياجاتك
                                            الخاصة.</p>
                                    </div>
                                </div>
                                <!-- Card 2 -->
                                <div class="col-md-3 col-sm-6 d-flex">
                                    <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100"
                                        style="border-radius: 30px;">
                                        <img src="{{ asset('Frontend/assets/images/icons/ribbon.png') }}"
                                            class="card-icon mb-3" alt="جودة عالية">
                                ...
                                <div class="col-md-3 col-sm-6 d-flex">
                                    <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100"
                                        style="border-radius: 30px;">
                                        <img src="{{ asset('Frontend/assets/images/icons/headphones.png') }}"
                                            class="card-icon mb-3" alt="تجربة عملاء مميزة">
                                ...
                                <div class="col-md-3 col-sm-6 d-flex">
                                    <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100"
                                        style="border-radius: 30px;">
                                        <img src="{{ asset('Frontend/assets/images/icons/Discount.png') }}"
                                            class="card-icon mb-3" alt="أسعار تنافسية">
                                ...
                                <div class="col-md-3 col-sm-6 d-flex">
                                    <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100"
                                        style="border-radius: 30px;">
                                        <img src="{{ asset('Frontend/assets/images/icons/garuntee.png') }}"
                                            class="card-icon mb-3" alt="الضمان">
                                ...
                                <div class="col-md-3 col-sm-6 d-flex">
                                    <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100"
                                        ...
                                        <img src="{{ asset('Frontend/assets/images/icons/date.png') }}"
                                            class="card-icon mb-3" alt="الالتزام بالمواعيد">
                                ...
                                <div class="col-md-3 col-sm-6 d-flex">
                                    <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100"
                                        style="border-radius: 30px;">
                                        <img src="{{ asset('Frontend/assets/images/icons/delivery.png') }}"
                                            class="card-icon mb-3" alt="توصيل مريح">
                                ...
                                <div class="col-md-3 col-sm-6 d-flex">
                                    <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100"
                                        style="border-radius: 30px;">
                                        <img src="{{ asset('Frontend/assets/images/icons/staff.png') }}"
                                            class="card-icon mb-3" alt="سهولة التواصل">
                    ...
                    <div id="responsibility" class="row align-items-center m-4">
                        <!-- Image Slider -->
