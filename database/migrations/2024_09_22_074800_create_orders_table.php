    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->enum('processing_stage', [
                ...
                'تم إرسال إيصال الدفعة الأولى من قبل العميل',
                'تم تسديد الدفعة الأولى',
                'تم إرسال تفاصيل الدفعة الثانية',
                'تم إرسال إيصال الدفعة الثانية من قبل العميل',
                'تم استلام الدفعة الثانية',
                'تم بدء التصنيع',
                'تم إنهاء التصنيع',
                'تم توصيل الطلب إلى المملكة العربية السعودية',
                'تم إرسال تفاصيل الدفعة الثالثة',
                'تم إرسال إيصال الدفعة الثالثة من قبل العميل',
